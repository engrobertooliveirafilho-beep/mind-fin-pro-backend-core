...
def bad_org_fragment_name(name):
...
class OrgFragmentCleaner:
    ...
    def run(self):
        bad=[a for a in self.animals() if bad_org_fragment_name(a.get("official_name"))]
        deleted_edges=0
        deleted_animals=0
        ...
        return {
            "status":"P5.5X3_ORG_FRAGMENT_CLEANER_DONE",
