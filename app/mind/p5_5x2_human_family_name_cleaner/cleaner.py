...
class HumanFamilyNameCleaner:
    ...
    def run(self):
        bad=[a for a in self.animals() if bad_human_family_name(a.get("official_name"))]
        deleted_edges=0
        deleted_animals=0
        ...
        return {
            "status":"P5.5X2_HUMAN_FAMILY_NAME_CLEANER_DONE",
