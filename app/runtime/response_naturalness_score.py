...
class ResponseNaturalnessScore(AdvancedRuntimeEngine):
    module_name = "response_naturalness_score"
    domain = "quality"
...
def health() -> dict[str, Any]:
    return ResponseNaturalnessScore().health()

def run(payload: dict[str, Any] | None = None) -> dict[str, Any]:
    return ResponseNaturalnessScore().run(payload)
