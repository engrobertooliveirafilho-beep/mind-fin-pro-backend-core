...
class SocialCognitionEngine(AdvancedRuntimeEngine):
    module_name = "social_cognition_engine"
    domain = "social"
...
def health() -> dict[str, Any]:
    return SocialCognitionEngine().health()

def run(payload: dict[str, Any] | None = None) -> dict[str, Any]:
    return SocialCognitionEngine().run(payload)
