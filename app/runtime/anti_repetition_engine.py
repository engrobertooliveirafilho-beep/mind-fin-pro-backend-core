...
class AntiRepetitionEngine(AdvancedRuntimeEngine):
    module_name = "anti_repetition_engine"
    domain = "quality"
...
def health() -> dict[str, Any]:
    return AntiRepetitionEngine().health()

def run(payload: dict[str, Any] | None = None) -> dict[str, Any]:
    return AntiRepetitionEngine().run(payload)
