...
class PersistentSocialMemory(AdvancedRuntimeEngine):
    module_name = "persistent_social_memory"
    domain = "social"
...
def health() -> dict[str, Any]:
    return PersistentSocialMemory().health()

def run(payload: dict[str, Any] | None = None) -> dict[str, Any]:
    return PersistentSocialMemory().run(payload)
