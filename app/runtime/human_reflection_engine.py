...
class HumanReflectionEngine(AdvancedRuntimeEngine):
    module_name = "human_reflection_engine"
    domain = "reflection"
...
def health() -> dict[str, Any]:
    return HumanReflectionEngine().health()

def run(payload: dict[str, Any] | None = None) -> dict[str, Any]:
    return HumanReflectionEngine().run(payload)
