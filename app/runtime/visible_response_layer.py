def visible_reformulate(answer: str, message: str, focus: str = "MIND") -> str:
    ...
    if "qual" in t and "melhor" in t:
        return f"A melhor decisão agora é melhorar a qualidade conversacional da Eldora. O {focus} já tem backend, WhatsApp, memória, RAG e LLM funcionando; o gargalo é ela responder de forma natural."

    if "porque" in t or "por que" in t or t == "pq?":
        return f"Porque a infraestrutura do {focus} já está operacional. Se continuarmos criando camada antes de corrigir a conversa, a Eldora fica maior, mas não necessariamente mais inteligente para o usuário."
