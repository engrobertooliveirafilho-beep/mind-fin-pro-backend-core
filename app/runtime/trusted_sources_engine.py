...
class TrustedSourcesEngine(AdvancedRuntimeEngine):
    module_name = "trusted_sources_engine"
    domain = "trust"
...
def health() -> dict[str, Any]:
    return TrustedSourcesEngine().health()

def run(payload: dict[str, Any] | None = None) -> dict[str, Any]:
    return TrustedSourcesEngine().run(payload)
