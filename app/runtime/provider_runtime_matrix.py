...
class ProviderRuntimeMatrix(AdvancedRuntimeEngine):
    module_name = "provider_runtime_matrix"
    domain = "provider"
...
def health() -> dict[str, Any]:
    return ProviderRuntimeMatrix().health()

def run(payload: dict[str, Any] | None = None) -> dict[str, Any]:
    return ProviderRuntimeMatrix().run(payload)
