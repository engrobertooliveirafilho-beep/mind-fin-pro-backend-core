...
class PersistentDialogueState(AdvancedRuntimeEngine):
    module_name = "persistent_dialogue_state"
    domain = "memory"
...
def health() -> dict[str, Any]:
    return PersistentDialogueState().health()

def run(payload: dict[str, Any] | None = None) -> dict[str, Any]:
    return PersistentDialogueState().run(payload)
