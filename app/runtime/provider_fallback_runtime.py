...
class ProviderFallbackRuntime(AdvancedRuntimeEngine):
    module_name = "provider_fallback_runtime"
    domain = "provider"
...
def health() -> dict[str, Any]:
    return ProviderFallbackRuntime().health()

def run(payload: dict[str, Any] | None = None) -> dict[str, Any]:
    return ProviderFallbackRuntime().run(payload)
