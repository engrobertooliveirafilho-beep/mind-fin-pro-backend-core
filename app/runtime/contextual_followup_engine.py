...
class ContextualFollowupEngine(AdvancedRuntimeEngine):
    module_name = "contextual_followup_engine"
    domain = "dialogue"
...
def health() -> dict[str, Any]:
    return ContextualFollowupEngine().health()

def run(payload: dict[str, Any] | None = None) -> dict[str, Any]:
    return ContextualFollowupEngine().run(payload)
