...
class SemanticDialogueMemory(AdvancedRuntimeEngine):
    module_name = "semantic_dialogue_memory"
    domain = "memory"
...
def health() -> dict[str, Any]:
    return SemanticDialogueMemory().health()

def run(payload: dict[str, Any] | None = None) -> dict[str, Any]:
    return SemanticDialogueMemory().run(payload)
