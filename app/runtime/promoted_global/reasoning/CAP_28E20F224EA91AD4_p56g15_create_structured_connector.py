...
base = Path("app/mind/p5_6g15_structured_pedigree_source_connector")
...
(base / "connector.py").write_text(code, encoding="utf-8")

print("CREATED=", base)
print("MISSION=P5.6G15_STRUCTURED_PEDIGREE_SOURCE_CONNECTOR")
print("MODE=NO_DB_MUTATION")
