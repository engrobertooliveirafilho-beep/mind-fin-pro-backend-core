...
$outDir = "reports\P14.16J_CLEAN_EDITOR_SYNTAX_PROBE\screenshots"
...
foreach ($file in $files) {
  ...
  $results += [pscustomobject]@{
    strategy_id=$sid
    file=$file
    status="TESTED_CLEAN_EDITOR"
    screenshot=$shot
  }
}

$csv="reports\P14.16J_CLEAN_EDITOR_SYNTAX_PROBE\syntax_probe_results.csv"
