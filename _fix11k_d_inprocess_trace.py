...
Path(r"_evidence\FIX11K_D_INPROCESS_TRACE_20260526_132906\REAL_HOP_TRACE.json").write_text(json.dumps(live,ensure_ascii=False,indent=2),encoding="utf-8")
Path(r"_evidence\FIX11K_D_INPROCESS_TRACE_20260526_132906\PIPELINE_TRACE_EVENTS.json").write_text(json.dumps(trace,ensure_ascii=False,indent=2),encoding="utf-8")
...
Path(r"_evidence\FIX11K_D_INPROCESS_TRACE_20260526_132906\FALLBACK_ORIGIN_AUDIT.json").write_text(json.dumps(origins,ensure_ascii=False,indent=2),encoding="utf-8")
