...
# [P19_LEGACY_DISABLED]         return "Vamos estabilizar continuidade, memória contextual e comportamento real do WhatsApp."

# [P19_LEGACY_DISABLED]     if "como fazer" in msg or "e como fazer" in msg:
# [P19_LEGACY_DISABLED]         return "Vamos fazer por memória contextual, continuidade e estabilizar comportamento real."
...
# [P19_LEGACY_DISABLED]     return str(reply)
...
# [P19_LEGACY_DISABLED]     if "como fazer" in text or "como faz" in text:
