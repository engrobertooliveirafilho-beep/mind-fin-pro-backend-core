...
$outDir="reports\P14.16N_DEBUG_AUTORUN\screenshots"
...
Write-Host "Arquivos para testar: $($files.Count)"
...
foreach($file in $files){
 ...
 Write-Host "Colado: $sid. Aguardando editor..."
...
$csv="reports\P14.16N_DEBUG_AUTORUN\results.csv"
