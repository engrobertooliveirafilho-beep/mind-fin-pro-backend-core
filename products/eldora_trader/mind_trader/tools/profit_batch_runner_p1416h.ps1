...
$files = @(
  "profit_import_package\p1416h_risk_f3_s21_t100.nts",
  "profit_import_package\p1416h_risk_f3_s21_t200.nts",
  "profit_import_package\p1416h_risk_f8_s34_t100.nts",
  "profit_import_package\p1416h_risk_f8_s34_t200.nts",
  "profit_import_package\p1416h_risk_f13_s55_t200.nts"
)
