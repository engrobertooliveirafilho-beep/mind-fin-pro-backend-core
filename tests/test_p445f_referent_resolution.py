...
def test_subject_alias_never_returns_isso():
    assert subject_alias("quero comprar um corolla") == "quero comprar um corolla"
    assert subject_alias("quero comprar um helicóptero robinson r44") == "quero comprar um helicóptero robinson r44"
