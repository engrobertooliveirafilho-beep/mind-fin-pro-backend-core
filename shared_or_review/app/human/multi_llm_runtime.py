...
class MultiLLMRuntime:
    ...
    def _openai(self, prompt):
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": "Você é a Eldora do MIND. Converse naturalmente, mantenha continuidade, responda de forma humana e contextual pelo WhatsApp."},
    ...
    def _deepseek(self, prompt):
        ...
        r = requests.post(
            ...
            json={
                "model": "deepseek-chat",
                "messages": [
                    {"role": "system", "content": "Você é a Eldora do MIND. Responda com continuidade contextual e sem linguagem robótica."},
                    {"role": "user", "content": prompt}
                ],
                "temperature": 0.55,
                "max_tokens": 700
