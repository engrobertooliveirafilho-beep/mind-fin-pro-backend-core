...
class MemoryProvider:
    def __init__(self):
        self.database_url=os.getenv("DATABASE_URL"); assert self.database_url, "DATABASE_URL missing"; assert self.database_url, "DATABASE_URL missing"; assert self.database_url, "DATABASE_URL missing"
    def _conn(self):
