...
base = Path("app/mind/p5_6g20_real_web_search_adapter")
...
(base / "__init__.py").write_text("from .adapter import run, serpapi_search\n", encoding="utf-8")
(base / "adapter.py").write_text(code, encoding="utf-8")

print("CREATED=", base)
print("MISSION=P5.6G20_REAL_WEB_SEARCH_ADAPTER")
print("MODE=REAL_SEARCH_NO_DB_MUTATION")
