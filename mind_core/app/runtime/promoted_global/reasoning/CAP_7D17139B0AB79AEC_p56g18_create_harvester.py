...
base = Path("app/mind/p5_6g18_automated_source_harvester")
...
(base / "__init__.py").write_text("from .harvester import build_harvest_plan\n", encoding="utf-8")
(base / "harvester.py").write_text(code, encoding="utf-8")

print("CREATED=", base)
print("MISSION=P5.6G18_AUTOMATED_SOURCE_HARVESTER")
print("MODE=PLAN_ONLY_NO_DB_MUTATION")
