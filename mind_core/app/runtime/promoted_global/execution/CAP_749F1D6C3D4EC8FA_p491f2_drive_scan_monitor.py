...
report = {
    "milestone": "P4.91F2 COMPLETE",
    "monitor": "DRIVE_SCAN_MONITOR",
    "generated_at": datetime.now(timezone.utc).isoformat(),
    "status": status,
    "remote": remote,
    "drive_folder_id": DRIVE_FOLDER_ID,
    "mode": "PRINT_SCAN_PROGRESS",
    "delete": "FORBIDDEN",
...
log(f"FINALIZADO | files={files} folders={folders} zips={zips} errors={len(errors)} elapsed={report['elapsed_seconds']}s")
